...
class Category(models.Model):
    ...
    shops = models.ManyToManyField(Shop, verbose_name='Магазины', related_name='categories', blank=False)
...
class ProductInfo(models.Model):
    ...
    product = models.ForeignKey(Product, verbose_name='Продукт',
                            related_name='products_infos', on_delete=models.CASCADE,
                            null=False)
    name = models.CharField(verbose_name='Название',max_length=50, blank=True, null=True)
    quantity = models.PositiveIntegerField(verbose_name='Кол-во', null=True)
...
class Order(models.Model):
    user = models.ForeignKey(User, verbose_name='Пользователь', 
                             ...
                             null=False)
    status = models.CharField(max_length=15, null=True, blank=True, default='Заказ собирается')
